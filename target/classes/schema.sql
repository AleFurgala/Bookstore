...
CREATE TABLE zamowienia (id INT AUTO_INCREMENT, id_klienci INT, id_ksiazki INT, data VARCHAR(255), PRIMARY KEY (id), FOREIGN KEY (id_klienci) REFERENCES klienci(id), FOREIGN KEY (id_ksiazki) REFERENCES ksiazki(id));
