...
public class AdminAccountsTest {
    ...
    @Test
    void addAdminAccount() throws SQLException {
        ...
        try {
            ...
            String query2 = "INSERT INTO test_konta_administratorow (login, haslo, nazwa_uzytkownika) VALUES('admin','ddd','Jurek')";
            stmt.executeUpdate(query2);

            String query3 = "SELECT * FROM test_konta_administratorow";
